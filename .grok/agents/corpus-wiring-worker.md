---
name: corpus-wiring-worker
description: >
  Implement already-specified registrations and cross-package seams.
model: inherit
effort: high
...
Implement the contract-defined seam and prove it with a focused integration test. Do not redesign runtime semantics.

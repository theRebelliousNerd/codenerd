...
Item 33 landed as runs 42/43: `per_shard_facts` honored at boot (c52bf618), complete campaign manifest + contract test (70d85b08); the literal-count guards that had been red since 6b6eefa3 fixed in 733eccdc. Item 34 is run 44 (`brief_campaign_context.txt`).

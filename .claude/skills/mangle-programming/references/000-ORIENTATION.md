...
→ 300-PATTERN_LIBRARY.md (Example 2: SBOM Analyzer)
...
**Policy Compliance**
→ 300-PATTERN_LIBRARY.md (Example 4: Infrastructure policy)
...
- 010-PROGRAMMING_MODEL.md: the seven patterns (what is asserted, what is derived, which pattern fits)
- 020-ENGINE_TRUTHS_v0.5.1.md: what was verified and refuted by running it on the pinned engine

The unnumbered files (ADVANCED_PATTERNS, PRODUCTION) hold worked programs and deployment notes
the numbered references do not repeat. SYNTAX.md duplicated 200-SYNTAX_REFERENCE.md (deleted
2026-09-18); EXAMPLES.md duplicated the first half of 300-PATTERN_LIBRARY.md (deleted 2026-09-19).
...
5. Contribute to codeberg.org/TauCeti/mangle-go (the fork codeNERD pins)

...
|----|-------|--------|-------------|
| [SK-001](references/skill-registry.md#sk-001-codenerd-builder) | codenerd-builder | Architecture | Kernel, transducers, shards, campaigns |
| [SK-002](references/skill-registry.md#sk-002-mangle-programming) | mangle-programming | Logic | Schemas, rules, queries, aggregation |
| [SK-003](references/skill-registry.md#sk-003-go-architect) | go-architect | Go Patterns | All Go code, concurrency, errors |
| [SK-004](references/skill-registry.md#sk-004-charm-tui) | charm-tui | Terminal UI | CLI interface, forms, lists |
| [SK-005](references/skill-registry.md#sk-005-research-builder) | research-builder | Knowledge | ResearcherShard, llms.txt, 4-tier memory |
| [SK-006](references/skill-registry.md#sk-006-rod-builder) | rod-builder | Browser | Web scraping, CDP, automation |
| [SK-007](references/skill-registry.md#sk-007-log-analyzer) | log-analyzer | Debugging | Log analysis, cross-system tracing |
| [SK-008](references/skill-registry.md#sk-008-skill-creator) | skill-creator | Tooling | Creating and packaging new skills |
| [SK-010](references/skill-registry.md#sk-010-cli-engine-integration) | cli-engine-integration | LLM Integration | Core |
| [SK-011](references/skill-registry.md#sk-011-prompt-architect) | prompt-architect | Prompt Engineering | Writing new shards, auditing prompts |
...
|-------|-------------|------------------|
| **codenerd-builder** | Implementing kernel, transducers, shards, campaigns | Architecture patterns, component structure, JIT prompt compilation |
| **mangle-programming** | Writing schemas, rules, queries, debugging logic | Mangle syntax, aggregation, stratification |
| **go-architect** | Any Go code - especially concurrency, error handling | Goroutine safety, context, testing patterns |
| **charm-tui** | Building the `nerd` CLI interface | Bubbletea, Lipgloss, forms, lists |
| **research-builder** | ResearcherShard, knowledge ingestion | llms.txt, Context7, 4-tier memory |
| **rod-builder** | Browser automation, scraper peripheral | CDP, session management, screenshots |
| **log-analyzer** | Debugging with logs, cross-system tracing | Log → Mangle facts, query patterns |
| **prompt-architect** | Writing shard prompts, auditing prompts | God Tier templates, JIT compilation, Piggyback protocol |
| **integration-auditor** | Pre-commit checks, debugging wiring issues, new features | 39-system audit, shard type matrix, diagnostics |

...
type GeminiThinkingConfig struct {
    ...
    ThinkingBudget  int    `json:"thinkingBudget,omitempty"`  // Gemini 2.5: 128-32768
}
```
...
| `gemini-2.5-pro` | 1M | 8K | Token budget thinking |
| `gemini-2.5-flash` | 1M | 8K | Fast, token budget |

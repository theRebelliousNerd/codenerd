...
# Safe to write check (uses helper for safe negation)
...
# =============================================================================
# Uses predicates from schemas.gl: build_state, diagnostic
...
# =============================================================================
# Uses predicate from schemas.gl: coder_state
...
# Binary file detection - uses is_binary_file from schemas.gl

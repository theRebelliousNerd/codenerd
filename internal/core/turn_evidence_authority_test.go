...
func TestModelCannotAssertTurnDone(t *testing.T) {
	forbidden := []string{
		"turn_done(/create).",
		"turn_executed(/create).",
		"turn_verified(/create).",
		"turn_unverified(/create).",
		"turn_wrote(/create).",
		"turn_build_failed(/create).",
		"turn_missing_evidence(/create, /tests_not_green).",
		"turn_evidence(/create, 1, 1, 1, /false, /false).",
		"turn_acceptance(/create, \"contract\", \"snapshot\").",
		"has_turn_acceptance(/create).",
		"turn_created_source(\"pkg/foo.go\").",

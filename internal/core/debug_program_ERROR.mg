...
# time_diff computes the absolute difference between two timestamps.
# Implementation: Diff = |Time1 - Time2|
# Note: Uses fn:minus for subtraction. Assumes Time1 >= Time2 for positive Diff.
time_diff(Time1, Time2, Diff) :-
    Time1 >= Time2,
    Diff = fn:minus(Time1, Time2).

time_diff(Time1, Time2, Diff) :-
    Time2 > Time1,
    Diff = fn:minus(Time2, Time1).

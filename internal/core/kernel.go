...
//
// - kernel_types.go: Type definitions, constants, and data structures (including RealKernel, Fact aliases, etc.)
// - kernel_init.go: Constructor functions (NewRealKernel, etc.)
// - kernel_facts.go: Fact management (Assert, Retract, LoadFacts, etc.)
// - kernel_query.go: Query execution and pattern matching
// - kernel_eval.go: Policy evaluation and rule execution

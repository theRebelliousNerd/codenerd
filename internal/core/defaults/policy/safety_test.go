...
func TestLogic_Safety(t *testing.T) {
	...
	for _, action := range []string{"/browser_observe", "/browser_act", "/browser_mangle", "/browser_wait", "/browser_reason", "/browser_evidence", "/browser_specs", "/browser_test", "/grounded_web_search"} {

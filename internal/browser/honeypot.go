...
// Deprecated: Rules are now loaded from internal/core/defaults/policy/browser_honeypot.mg
func HoneypotRules() string {
	return ""
}

// BrowserSchemas returns the Mangle schemas for browser facts.
// Deprecated: Schemas are now loaded from internal/core/defaults/schemas_browser.mg

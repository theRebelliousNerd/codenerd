...
// Optimization: Uses type switching and strconv for primitive types to avoid
// the high overhead of reflection used by fmt.Sprintf.
// Benchmarks show ~2x speedup for int and ~22x for bool.
func extractStringArg(arg interface{}) string {
	...
	case float64:
		// Use 'g' format to match fmt.Sprintf("%v") behavior (compact scientific notation)

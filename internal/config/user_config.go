...
func DefaultUserConfig() *UserConfig {
	...
	return &UserConfig{
		...
		Onboarding: &OnboardingState{
			SetupComplete:   true,
			ExperienceLevel: ExperienceAdvanced,
			FirstRunAt:      "2026-06-18T00:00:00Z",
			Milestones:      []string{"setup_complete", "tour_complete"},
		...
		Transparency: &TransparencyConfig{
			...
			GlassBoxDisabled:   false,
			GlassBoxCategories: []string{},

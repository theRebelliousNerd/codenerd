...
func TestAllCategoriesLog(t *testing.T) {
	...
	Get(CategoryCoder).Info("Convenience coder log")
	Get(CategoryTester).Info("Convenience tester log")
	Get(CategoryReviewer).Info("Convenience reviewer log")
...
func TestCategoryToggle(t *testing.T) {
	...
	Get(CategoryCoder).Info("This SHOULD be logged (default enabled)")

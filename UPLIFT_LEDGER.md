...
### internal/core/query_differential_test.go (1)
- [x] `internal/core/query_differential_test.go`
...
- [x] `internal/perception/client_openrouter_uplift_test.go`
...
- [x] `internal/store/vector_backfill_race_test.go`

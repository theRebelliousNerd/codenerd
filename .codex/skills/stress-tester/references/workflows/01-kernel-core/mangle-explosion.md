...
Get-Content .codex/skills/stress-tester/assets/cyclic_rules.mg | Select-Object -First 20

# Attempt to validate (should work but may warn)
./nerd.exe check-mangle .codex/skills/stress-tester/assets/cyclic_rules.mg
```
...
```bash
cd .codex/skills/stress-tester/scripts

...
Decl mutable_list(L) bound [/list].
mutable_list([1, 2, 3]).
...
Decl hashmap(K, V) bound [/name, /number].
hashmap(/key1, 100).
hashmap(/key2, 200).
...
Decl proper_struct(S) bound [/struct].

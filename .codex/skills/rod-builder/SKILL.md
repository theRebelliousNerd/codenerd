---
name: rod-builder
description: Build production-ready browser automation with Rod (go-rod/rod). This skill should be used when the user asks for Rod or CDP automation, web scraping, E2E testing, browser session management, screenshots or PDFs, or programmatic Chromium control. Includes Rod API patterns, CDP event handling, Chromium configuration, launcher flags, testing strategies, and production-grade best practices. (project)
---
...
- Implementing Rod or CDP-based browser automation in Go
- Building web scrapers or data extraction tools
- Running end-to-end tests with real browsers
- Developing browser session management or incognito workflows
- Debugging web applications via CDP inspection
- Creating screenshot or PDF generation services
- Building tools that require programmatic Chromium control

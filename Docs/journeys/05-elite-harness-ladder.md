...
| 15 | Run with everything on, and use codeNERD's own architecture review / enhancement and pruning while dogfooding | open: also `.nerd/context/` holds 320 per-scope working-set databases nothing prunes |

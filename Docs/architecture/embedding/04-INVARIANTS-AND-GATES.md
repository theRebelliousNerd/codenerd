# embedding — Invariants and Gates
...
1. Source under `internal/embedding/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/embedding/...` |
| Race (when concurrent) | `go test -race ./internal/embedding/...` |

...
- Primary: `internal/embedding/` (**1:1 package root**)
- Non-test Go files: **6**
- Test files: **7**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-EMBEDDING.md](02-CURRENT-STATE-EMBEDDING.md) | Living inventory |
| [03-GAP-ANALYSIS-EMBEDDING.md](03-GAP-ANALYSIS-EMBEDDING.md) | Gaps vs north star |

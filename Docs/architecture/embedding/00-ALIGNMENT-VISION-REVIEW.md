# embedding — Alignment & Vision Review
...
| Test grounding | 4 | 7 tests / 6 src |

## Verdict

Living package under `internal/embedding/`. Full corpus is **code-grounded**, not pre-implementation fiction.

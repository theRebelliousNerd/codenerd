...
| JIT / atom discipline | 5 | prompt atoms |
| Observability | 3 | logs/metrics |
| Test grounding | 4 | 32 tests / 25 src |

## Verdict

Living package under `internal/prompt/`. Full corpus is **code-grounded**, not pre-implementation fiction.

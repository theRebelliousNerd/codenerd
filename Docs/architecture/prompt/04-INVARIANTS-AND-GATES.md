...
1. Source under `internal/prompt/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/prompt/...` |
| Race (when concurrent) | `go test -race ./internal/prompt/...` |

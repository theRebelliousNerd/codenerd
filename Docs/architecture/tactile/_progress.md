...
| Date | Note |
|------|------|
| 2026-08-09 | Reconciled OutputAnalyzer facts with live Mangle Decls; added real-kernel injection proof and hardened audit file lifecycle, redaction, bounds, fallback events, and sink-error observability. |

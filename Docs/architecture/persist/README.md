...
- Primary: `internal/persist/` (**1:1 package root**)
- Non-test Go files: **1**
- Test files: **4**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-PERSIST.md](02-CURRENT-STATE-PERSIST.md) | Living inventory |
| [03-GAP-ANALYSIS-PERSIST.md](03-GAP-ANALYSIS-PERSIST.md) | Gaps vs north star |

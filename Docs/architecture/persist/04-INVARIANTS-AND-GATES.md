...
1. Source under `internal/persist/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/persist/...` |
| Race (when concurrent) | `go test -race ./internal/persist/...` |

...
| Assault campaigns | `campaign assault` | `/campaign assault …` | **parity reached 2026-08-15** — every `AssaultConfig` field has a Cobra flag; see [campaign corpus](../campaign/README.md#adversarial-assault) |

# sqlpragmas — Cross-System Wiring
...
| Surface | Path | Notes |
|---------|------|-------|
| This package | `internal/sqlpragmas/` | Exists |
...
Do not invent routes or registrations. Grep registration hubs and callers before asserting a wire is live for **sqlpragmas**.

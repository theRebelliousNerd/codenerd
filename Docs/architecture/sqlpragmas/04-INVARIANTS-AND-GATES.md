# sqlpragmas — Invariants and Gates
...
1. Source under `internal/sqlpragmas/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/sqlpragmas/...` |
| Race (when concurrent) | `go test -race ./internal/sqlpragmas/...` |

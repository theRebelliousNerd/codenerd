...
- Primary: `internal/system/` (**1:1 package root**)
- Non-test Go files: **5**
- Test files: **11**
- Mangle sources: **1**
...
| [02-CURRENT-STATE-SYSTEM.md](02-CURRENT-STATE-SYSTEM.md) | Living inventory |
| [03-GAP-ANALYSIS-SYSTEM.md](03-GAP-ANALYSIS-SYSTEM.md) | Gaps vs north star |

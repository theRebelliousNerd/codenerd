# transparency — Cross-System Wiring
...
| Surface | Path | Notes |
|---------|------|-------|
| This package | `internal/transparency/` | Exists |
...
Do not invent routes or registrations. Grep registration hubs and callers before asserting a wire is live for **transparency**.

# transparency — Invariants and Gates
...
1. Source under `internal/transparency/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/transparency/...` |
| Race (when concurrent) | `go test -race ./internal/transparency/...` |

# observability — Invariants and Gates
...
1. Source under `internal/observability/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/observability/...` |
| Race (when concurrent) | `go test -race ./internal/observability/...` |

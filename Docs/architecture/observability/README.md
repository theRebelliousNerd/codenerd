# observability — Architecture Corpus
...
- Primary: `internal/observability/` (**1:1 package root**)
- Non-test Go files: **2**
- Test files: **3**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-OBSERVABILITY.md](02-CURRENT-STATE-OBSERVABILITY.md) | Living inventory |
| [03-GAP-ANALYSIS-OBSERVABILITY.md](03-GAP-ANALYSIS-OBSERVABILITY.md) | Gaps vs north star |

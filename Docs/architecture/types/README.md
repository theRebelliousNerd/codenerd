...
- Primary: `internal/types/` (**1:1 package root**)
- Non-test Go files: **5**
- Test files: **4**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-TYPES.md](02-CURRENT-STATE-TYPES.md) | Living inventory |
| [03-GAP-ANALYSIS-TYPES.md](03-GAP-ANALYSIS-TYPES.md) | Gaps vs north star |

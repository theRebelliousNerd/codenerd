...
1. Source under `internal/types/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/types/...` |
| Race (when concurrent) | `go test -race ./internal/types/...` |

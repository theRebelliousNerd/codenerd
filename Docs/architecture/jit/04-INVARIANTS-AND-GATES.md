...
1. Source under `internal/jit/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/jit/...` |
| Race (when concurrent) | `go test -race ./internal/jit/...` |

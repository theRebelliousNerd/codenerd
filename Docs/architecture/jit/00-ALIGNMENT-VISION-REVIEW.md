...
| JIT / atom discipline | 4 | prompt atoms |
| Observability | 3 | logs/metrics |
| Test grounding | 4 | 1 tests / 1 src |

## Verdict

Living package under `internal/jit/`. Full corpus is **code-grounded**, not pre-implementation fiction.

# features — Alignment & Vision Review
...
| Test grounding | 4 | 3 tests / 1 src |

## Verdict

Living package under `internal/features/`. Full corpus is **code-grounded**, not pre-implementation fiction.

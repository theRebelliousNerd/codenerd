...
- Primary: `internal/features/` (**1:1 package root**)
- Non-test Go files: **1**
- Test files: **3**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-FEATURES.md](02-CURRENT-STATE-FEATURES.md) | Living inventory |
| [03-GAP-ANALYSIS-FEATURES.md](03-GAP-ANALYSIS-FEATURES.md) | Gaps vs north star |

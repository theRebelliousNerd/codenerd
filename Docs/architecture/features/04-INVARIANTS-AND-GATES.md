...
1. Source under `internal/features/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/features/...` |
| Race (when concurrent) | `go test -race ./internal/features/...` |

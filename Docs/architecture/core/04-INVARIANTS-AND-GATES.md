...
1. Source under `internal/core/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/core/...` |
| Race (when concurrent) | `go test -race ./internal/core/...` |

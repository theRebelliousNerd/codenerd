...
| Test grounding | 4 | 16 tests / 10 src |

## Verdict

Living package under `internal/mcp/`. Full corpus is **code-grounded**, not pre-implementation fiction.

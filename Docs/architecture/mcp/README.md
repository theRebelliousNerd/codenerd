...
- Primary: `internal/mcp/` (**1:1 package root**)
- Non-test Go files: **10**
- Test files: **16**
- Mangle sources: **1**
...
| [02-CURRENT-STATE-MCP.md](02-CURRENT-STATE-MCP.md) | Living inventory |
| [03-GAP-ANALYSIS-MCP.md](03-GAP-ANALYSIS-MCP.md) | Gaps vs north star |

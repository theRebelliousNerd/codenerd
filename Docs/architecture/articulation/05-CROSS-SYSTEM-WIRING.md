...
| Surface | Path | Notes |
|---------|------|-------|
| This package | `internal/articulation/` | Exists |
...
Do not invent routes or registrations. Grep registration hubs and callers before asserting a wire is live for **articulation**.

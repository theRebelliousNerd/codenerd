...
- Primary: `internal/retrieval/` (**1:1 package root**)
- Non-test Go files: **4**
- Test files: **6**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-RETRIEVAL.md](02-CURRENT-STATE-RETRIEVAL.md) | Living inventory |
| [03-GAP-ANALYSIS-RETRIEVAL.md](03-GAP-ANALYSIS-RETRIEVAL.md) | Gaps vs north star |

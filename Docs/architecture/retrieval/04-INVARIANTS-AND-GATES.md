# retrieval — Invariants and Gates
...
1. Source under `internal/retrieval/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/retrieval/...` |
| Race (when concurrent) | `go test -race ./internal/retrieval/...` |

# northstar — Invariants and Gates
...
1. Source under `internal/northstar/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/northstar/...` |
| Race (when concurrent) | `go test -race ./internal/northstar/...` |

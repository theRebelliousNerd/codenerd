...
1. Source under `internal/world/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/world/...` |
| Race (when concurrent) | `go test -race ./internal/world/...` |

# verification — Invariants and Gates
...
1. Source under `internal/verification/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/verification/...` |
| Race (when concurrent) | `go test -race ./internal/verification/...` |

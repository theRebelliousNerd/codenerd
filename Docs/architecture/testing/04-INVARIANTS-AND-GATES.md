...
1. Source under `internal/testing/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/testing/...` |
| Race (when concurrent) | `go test -race ./internal/testing/...` |

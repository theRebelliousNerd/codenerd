...
- Primary: `internal/testing/` (**1:1 package root**)
- Non-test Go files: **21**
- Test files: **8**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-TESTING.md](02-CURRENT-STATE-TESTING.md) | Living inventory |
| [03-GAP-ANALYSIS-TESTING.md](03-GAP-ANALYSIS-TESTING.md) | Gaps vs north star |

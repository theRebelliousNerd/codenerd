...
1. Source under `internal/context/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/context/...` |
| Race (when concurrent) | `go test -race ./internal/context/...` |

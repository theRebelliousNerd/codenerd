# perception — Invariants and Gates
...
1. Source under `internal/perception/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/perception/...` |
| Race (when concurrent) | `go test -race ./internal/perception/...` |

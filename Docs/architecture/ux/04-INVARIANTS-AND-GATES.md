...
1. Source under `internal/ux/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/ux/...` |
| Race (when concurrent) | `go test -race ./internal/ux/...` |

...
- Primary: `internal/ux/` (**1:1 package root**)
- Non-test Go files: **4**
- Test files: **4**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-UX.md](02-CURRENT-STATE-UX.md) | Living inventory |
| [03-GAP-ANALYSIS-UX.md](03-GAP-ANALYSIS-UX.md) | Gaps vs north star |

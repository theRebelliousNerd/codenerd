...
1. Source under `internal/campaign/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/campaign/...` |
| Race (when concurrent) | `go test -race ./internal/campaign/...` |

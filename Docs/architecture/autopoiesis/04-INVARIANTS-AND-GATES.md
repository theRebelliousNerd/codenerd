# autopoiesis — Invariants and Gates
...
1. Source under `internal/autopoiesis/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/autopoiesis/...` |
| Race (when concurrent) | `go test -race ./internal/autopoiesis/...` |

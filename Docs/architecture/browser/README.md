...
- Primary: `internal/browser/` (**1:1 package root**)
- Non-test Go files: **3**
- Test files: **6**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-BROWSER.md](02-CURRENT-STATE-BROWSER.md) | Living inventory |
| [03-GAP-ANALYSIS-BROWSER.md](03-GAP-ANALYSIS-BROWSER.md) | Gaps vs north star |

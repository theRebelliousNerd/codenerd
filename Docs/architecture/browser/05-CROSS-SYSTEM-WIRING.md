...
| Surface | Path | Notes |
|---------|------|-------|
| This package | `internal/browser/` | Exists |
...
Do not invent routes or registrations. Grep registration hubs and callers before asserting a wire is live for **browser**.

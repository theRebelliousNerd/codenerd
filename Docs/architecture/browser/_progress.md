...
- Source: 16 checked-in non-test Go files across `internal/browser`, `internal/browser/security`, and `internal/browser/specs` (15 per platform), 15 tests, 0 package-local `.mg`

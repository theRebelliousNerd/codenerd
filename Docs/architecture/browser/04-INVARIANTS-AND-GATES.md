...
1. Source under `internal/browser/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/browser/...` |
| Race (when concurrent) | `go test -race ./internal/browser/...` |

...
1. Source under `internal/build/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/build/...` |
| Race (when concurrent) | `go test -race ./internal/build/...` |

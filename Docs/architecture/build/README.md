...
- Primary: `internal/build/` (**1:1 package root**)
- Non-test Go files: **1**
- Test files: **2**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-BUILD.md](02-CURRENT-STATE-BUILD.md) | Living inventory |
| [03-GAP-ANALYSIS-BUILD.md](03-GAP-ANALYSIS-BUILD.md) | Gaps vs north star |

...
1. Source under `internal/usage/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/usage/...` |
| Race (when concurrent) | `go test -race ./internal/usage/...` |

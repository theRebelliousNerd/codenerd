...
| Test grounding | 4 | 2 tests / 1 src |

## Verdict

Living package under `internal/diff/`. Full corpus is **code-grounded**, not pre-implementation fiction.

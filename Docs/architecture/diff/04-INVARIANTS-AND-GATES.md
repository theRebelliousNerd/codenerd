...
1. Source under `internal/diff/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/diff/...` |
| Race (when concurrent) | `go test -race ./internal/diff/...` |

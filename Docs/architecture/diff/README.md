...
- Primary: `internal/diff/` (**1:1 package root**)
- Non-test Go files: **1**
- Test files: **2**
- Mangle sources: **0**
...
| [02-CURRENT-STATE-DIFF.md](02-CURRENT-STATE-DIFF.md) | Living inventory |
| [03-GAP-ANALYSIS-DIFF.md](03-GAP-ANALYSIS-DIFF.md) | Gaps vs north star |

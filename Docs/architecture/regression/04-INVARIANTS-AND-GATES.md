# regression — Invariants and Gates
...
1. Source under `internal/regression/` is authoritative over this corpus.
...
| Gate | Check |
|------|-------|
| Tests | `go test ./internal/regression/...` |
| Race (when concurrent) | `go test -race ./internal/regression/...` |

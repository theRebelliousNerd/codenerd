...
description: Comprehensive audit and repair of integration wiring across all codeNERD systems. This skill should be used when the user asks to verify end-to-end wiring, debug "code exists but doesn't run" issues, integrate new features or shards, or trace missing hooks across systems.
---
...
- Implementing or wiring new features or shards (Type A/B/U/S)
- Debugging "code exists but doesn't run" or "works in isolation" failures
- Verifying end-to-end wiring and missing hooks across systems
- Pre-commit integration verification
- Investigating silent failures or integration gaps

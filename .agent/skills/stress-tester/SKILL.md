---
name: stress-tester
description: Live stress testing of codeNERD via CLI. This skill should be used when the user asks to run stress tests, chaos or assault campaigns, find panics, edge cases, or failure modes across subsystems, or validate system stability and Mangle self-healing.
---
...
- Running stress tests, chaos runs, or assault campaigns
- Pre-release stability verification or after major architectural changes
- Debugging intermittent failures or hard-to-reproduce panics
- Finding edge cases, panic vectors, or resource limits

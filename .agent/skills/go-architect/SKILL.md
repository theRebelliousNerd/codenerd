---
name: go-architect
description: Write production-ready, idiomatic Go (Golang) code following Uber Go Style Guide patterns. This skill should be used when the user asks to write, review, or refactor Go code, especially concurrency (goroutines, channels), context usage, error handling, memory safety, or Go build/runtime integration (go:embed, CGO, SQLite, Mangle).
license: Apache-2.0
version: 1.1.0
go_version: 1.21+

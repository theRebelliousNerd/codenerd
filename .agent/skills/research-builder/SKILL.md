...
description: Build production-ready knowledge research and ingestion systems for codeNERD ShardAgents. This skill should be used when the user asks to implement ResearcherShard features, llms.txt or Context7-style documentation ingestion, knowledge atom extraction, quality scoring, or 4-tier memory persistence and specialist hydration. (project)
---
...
- Building llms.txt or Context7-style documentation ingestion pipelines
- Defining KnowledgeAtom extraction or LLM enrichment workflows
- Implementing quality scoring for documentation sources
- Wiring 4-tier memory persistence (RAM, Vector, Graph, Cold)
- Hydrating specialist shards with curated knowledge
- Debugging research ingestion or execution paths
